    ...
    run: async function (client, interaction, options) {
        ...
        try {
            interaction.channel.send({ embeds: [embed] }).then(message => {
                ...
                message?.react('🇨');
                message?.react('🇩');
                message?.react(message.guild.emojis.cache.find(emoji => emoji.name === 'ESE'));
                message?.react(message.guild.emojis.cache.find(emoji => emoji.name === 'AII'));
                message?.react('⚡');
                message?.react('👨‍🏭');
                message?.react('🍺');
                message?.react(message.guild.emojis.cache.find(emoji => emoji.name === 'Sportif'));
                message?.react('🎵');
                message?.react('🏨');
                message?.react('🕵️‍♂️');
            });
