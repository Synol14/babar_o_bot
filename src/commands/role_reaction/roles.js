...
module.exports = {
    ...
    run: async function (client, interaction, options) {
        ...
        const embed = new MessageEmbed()
            ...
            .addField('Pour les deuxièmes années (S3) :', `1️⃣ - Init 1\n2️⃣ - Init 2\n3️⃣ - Init 3\n4️⃣ - Init 4`)
            .addField('Pour les deuxièmes et troisièmes années :', `${interaction.guild.emojis.cache.find(emoji => emoji.name === 'ESE')} - ESE\n${interaction.guild.emojis.cache.find(emoji => emoji.name === 'AII')} - AII\n⚡ - EME\n👨‍🏭 - Alternant`)
